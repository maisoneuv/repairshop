export default function FieldRow({
            ...
            case 'number':
                return (
                    <input
                        ...
                        value={value || ''}
                        onChange={(e) => onChange(e.target.value)}
                        className="w-full border border-gray-300 rounded px-2.5 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 tabular-nums"
                    />
                );
    ...
    return (
        <div id={name ? `field-${name}` : undefined} className="grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-3 py-1">
            {/* Label Column */}
